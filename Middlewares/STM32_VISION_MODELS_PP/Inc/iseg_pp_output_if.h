...
#ifndef __ISEG_POSTPROCESS_OUTPUT_IF_H__
#define __ISEG_POSTPROCESS_OUTPUT_IF_H__
...
typedef struct
{
	iseg_postprocess_outBuffer_t *pOutBuff;
	int32_t nb_detect;
} iseg_postprocess_out_t;

#ifdef __cplusplus
 }
#endif

#endif      /* __ISEG_POSTPROCESS_OUTPUT_IF_H__  */
