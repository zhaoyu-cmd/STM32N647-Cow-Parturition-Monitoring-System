...
extern void dma_Channel0_callback(void);    /* DMA回调函数 */
extern void dma_Channel1_callback(void);    /* DMA传输完成回调函数 */
extern void jpeg_decode_callback(void);     /* JPEG信息头解码回调函数 */

extern JPEG_HandleTypeDef hjpeg; /* JPEG句柄 */
extern DMA_HandleTypeDef handle_HPDMA1_Channel1; /* JPEG数据输出DMA */
extern DMA_HandleTypeDef handle_HPDMA1_Channel0; /* JPEG数据输入DMA */
/******************************************************************************************/
