...
#define NRF24L01_CE_GPIO_PIN               GPIO_PIN_13
#define NRF24L01_CE_GPIO_CLK_ENABLE()      do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* PM口时钟使能 */

#define NRF24L01_CSN_GPIO_PORT             GPIOH
#define NRF24L01_CSN_GPIO_PIN              GPIO_PIN_6
#define NRF24L01_CSN_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOH_CLK_ENABLE(); }while(0)   /* PM口时钟使能 */

#define NRF24L01_IRQ_GPIO_PORT             GPIOD
#define NRF24L01_IRQ_GPIO_PIN              GPIO_PIN_11
#define NRF24L01_IRQ_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* PF口时钟使能 */
