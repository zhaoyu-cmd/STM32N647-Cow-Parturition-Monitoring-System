...
/**
* @brief ETH MSP Initialization (added for NetXDuo TCP notifier)
*/
void HAL_ETH_MspInit(ETH_HandleTypeDef* heth)
{
  ...
  if(heth->Instance==ETH1)
  {
    ...
    /* ETH1 RMII pin map:
       PH5 -> MDC, PF4 -> MDIO, PF10 -> CRS_DV, PF7 -> REF_CLK,
       PF15 -> RXD1, PF14 -> RXD0, PF11 -> TX_EN, PF13 -> TXD1, PF12 -> TXD0
       (PF5 is reused below as YT8512C PHY reset, output mode.) */
    ...
    GPIO_InitStruct.Pin = GPIO_PIN_4|GPIO_PIN_10|GPIO_PIN_7
    ...
    /* PF5 = YT8512C PHY reset (held low, then released after ETH init).
       The HAL_AF mode set above on PF5 was for ETH1_CLK; immediately
       redefine PF5 as GPIO output for the reset signal. */
